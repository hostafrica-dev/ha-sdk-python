...
```python
from hostafrica_sdk_python.models.create_notification_input import CreateNotificationInput

# TODO update the JSON string below
json = "{}"
# create an instance of CreateNotificationInput from a JSON string
create_notification_input_instance = CreateNotificationInput.from_json(json)
# print the JSON string representation of the object
print(CreateNotificationInput.to_json())

# convert the object into a dict
create_notification_input_dict = create_notification_input_instance.to_dict()
# create an instance of CreateNotificationInput from a dict
create_notification_input_from_dict = CreateNotificationInput.from_dict(create_notification_input_dict)
```
