...
update_power_task_request_content_instance = UpdatePowerTaskRequestContent.from_json(json)
# print the JSON string representation of the object
print(UpdatePowerTaskRequestContent.to_json())

# convert the object into a dict
update_power_task_request_content_dict = update_power_task_request_content_instance.to_dict()
# create an instance of UpdatePowerTaskRequestContent from a dict
update_power_task_request_content_from_dict = UpdatePowerTaskRequestContent.from_dict(update_power_task_request_content_dict)
```
