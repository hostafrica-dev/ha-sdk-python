...
[**list_allowed_features**](VPSManagementApi.md#list_allowed_features) | **POST** /vps/list-allowed-features | 
...
[**suspend_vps**](VPSManagementApi.md#suspend_vps) | **POST** /vps/suspend | 
[**terminate_vps**](VPSManagementApi.md#terminate_vps) | **POST** /vps/terminate | 
[**trigger_reinstall**](VPSManagementApi.md#trigger_reinstall) | **POST** /vps/trigger-reinstall | 
[**unsuspend_vps**](VPSManagementApi.md#unsuspend_vps) | **POST** /vps/unsuspend | 
...
> ListAllowedFeaturesResponseContent list_allowed_features(list_allowed_features_request_content)
...
with hostafrica_sdk_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = hostafrica_sdk_python.VPSManagementApi(api_client)
    list_allowed_features_request_content = hostafrica_sdk_python.ListAllowedFeaturesRequestContent() # ListAllowedFeaturesRequestContent | 

    try:
        api_response = api_instance.list_allowed_features(list_allowed_features_request_content)
        print("The response of VPSManagementApi->list_allowed_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VPSManagementApi->list_allowed_features: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **list_allowed_features_request_content** | [**ListAllowedFeaturesRequestContent**](ListAllowedFeaturesRequestContent.md)|  | 
...
# **suspend_vps**
> SuspendVpsResponseContent suspend_vps(suspend_vps_request_content)
...
with hostafrica_sdk_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = hostafrica_sdk_python.VPSManagementApi(api_client)
    suspend_vps_request_content = hostafrica_sdk_python.SuspendVpsRequestContent() # SuspendVpsRequestContent | 

    try:
        api_response = api_instance.suspend_vps(suspend_vps_request_content)
        print("The response of VPSManagementApi->suspend_vps:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VPSManagementApi->suspend_vps: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **suspend_vps_request_content** | [**SuspendVpsRequestContent**](SuspendVpsRequestContent.md)|  | 
...
with hostafrica_sdk_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of VPSManagementApi->terminate_vps:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VPSManagementApi->terminate_vps: %s\n" % e)
```
...
# **unsuspend_vps**
> UnsuspendVpsResponseContent unsuspend_vps(unsuspend_vps_request_content)
...
with hostafrica_sdk_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = hostafrica_sdk_python.VPSManagementApi(api_client)
    unsuspend_vps_request_content = hostafrica_sdk_python.UnsuspendVpsRequestContent() # UnsuspendVpsRequestContent | 

    try:
        api_response = api_instance.unsuspend_vps(unsuspend_vps_request_content)
        print("The response of VPSManagementApi->unsuspend_vps:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VPSManagementApi->unsuspend_vps: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **unsuspend_vps_request_content** | [**UnsuspendVpsRequestContent**](UnsuspendVpsRequestContent.md)|  | 
