...
[**create_snapshot_job**](SnapshotsApi.md#create_snapshot_job) | **POST** /vps/create-snapshot-job | 
[**delete_snapshot**](SnapshotsApi.md#delete_snapshot) | **POST** /vps/delete-snapshot | 
[**delete_snapshot_job**](SnapshotsApi.md#delete_snapshot_job) | **POST** /vps/delete-snapshot-job | 
[**list_snapshot_jobs**](SnapshotsApi.md#list_snapshot_jobs) | **POST** /vps/list-snapshot-jobs | 
...
[**update_snapshot_job**](SnapshotsApi.md#update_snapshot_job) | **POST** /vps/update-snapshot-job | 
...
with ha_sdk_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = ha_sdk_python.SnapshotsApi(api_client)
    create_snapshot_job_request_content = ha_sdk_python.CreateSnapshotJobRequestContent() # CreateSnapshotJobRequestContent | 

    try:
        api_response = api_instance.create_snapshot_job(create_snapshot_job_request_content)
        print("The response of SnapshotsApi->create_snapshot_job:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SnapshotsApi->create_snapshot_job: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **create_snapshot_job_request_content** | [**CreateSnapshotJobRequestContent**](CreateSnapshotJobRequestContent.md)|  | 
...
with ha_sdk_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = ha_sdk_python.SnapshotsApi(api_client)
    delete_snapshot_job_request_content = ha_sdk_python.DeleteSnapshotJobRequestContent() # DeleteSnapshotJobRequestContent | 

    try:
        api_response = api_instance.delete_snapshot_job(delete_snapshot_job_request_content)
        print("The response of SnapshotsApi->delete_snapshot_job:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SnapshotsApi->delete_snapshot_job: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **delete_snapshot_job_request_content** | [**DeleteSnapshotJobRequestContent**](DeleteSnapshotJobRequestContent.md)|  | 
...
with ha_sdk_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = ha_sdk_python.SnapshotsApi(api_client)
    list_snapshot_jobs_request_content = ha_sdk_python.ListSnapshotJobsRequestContent() # ListSnapshotJobsRequestContent | 

    try:
        api_response = api_instance.list_snapshot_jobs(list_snapshot_jobs_request_content)
        print("The response of SnapshotsApi->list_snapshot_jobs:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SnapshotsApi->list_snapshot_jobs: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **list_snapshot_jobs_request_content** | [**ListSnapshotJobsRequestContent**](ListSnapshotJobsRequestContent.md)|  | 
...
with ha_sdk_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = ha_sdk_python.SnapshotsApi(api_client)
    update_snapshot_job_request_content = ha_sdk_python.UpdateSnapshotJobRequestContent() # UpdateSnapshotJobRequestContent | 

    try:
        api_response = api_instance.update_snapshot_job(update_snapshot_job_request_content)
        print("The response of SnapshotsApi->update_snapshot_job:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SnapshotsApi->update_snapshot_job: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **update_snapshot_job_request_content** | [**UpdateSnapshotJobRequestContent**](UpdateSnapshotJobRequestContent.md)|  | 
