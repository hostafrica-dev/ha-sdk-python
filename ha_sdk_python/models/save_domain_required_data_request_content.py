...
class SaveDomainRequiredDataRequestContent(BaseModel):
    """
    SaveDomainRequiredDataRequestContent
    """ # noqa: E501
    domain_id: StrictStr = Field(description="Domain service id - must be sent as a string")
    fields: Dict[str, StrictStr] = Field(description="Registrar field values keyed by additionalFields[].name")
    __properties: ClassVar[List[str]] = ["domain_id", "fields"]
