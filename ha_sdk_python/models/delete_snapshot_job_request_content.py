...
class DeleteSnapshotJobRequestContent(BaseModel):
    """
    DeleteSnapshotJobRequestContent
    """ # noqa: E501
    service_id: StrictStr = Field(description="Service ID - must be sent as a string")
    job_id: StrictStr = Field(description="Snapshot job ID to delete")
    __properties: ClassVar[List[str]] = ["service_id", "job_id"]
