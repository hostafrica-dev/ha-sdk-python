...
class AllowedFeaturesResponseData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["message", "features"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "features": VpsAvailableFeatures.from_dict(obj["features"]) if obj.get("features") is not None else None
        })
        return _obj
