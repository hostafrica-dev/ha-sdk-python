...
class GetOsTemplateDetailsRequestContent(BaseModel):
    """
    GetOsTemplateDetailsRequestContent
    """ # noqa: E501
    service_id: StrictStr = Field(description="Service ID - must be sent as a string")
    image_id: StrictStr = Field(description="Image identifier for the OS template", alias="imageId")
    __properties: ClassVar[List[str]] = ["service_id", "imageId"]
