...
class ListOsTemplatesResponseData(BaseModel):
    """
    Response data for list OS templates operation
    """ # noqa: E501
    message: StrictStr = Field(description="Status message indicating the result")
    images: List[OsImage] = Field(description="List of available OS images")
    __properties: ClassVar[List[str]] = ["message", "images"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "images": [OsImage.from_dict(_item) for _item in obj["images"]] if obj.get("images") is not None else None
        })
        return _obj
