...
class GetOsTemplateDetailsResponseData(BaseModel):
    """
    ...
    image: OsImage
    __properties: ClassVar[List[str]] = ["message", "image"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "image": OsImage.from_dict(obj["image"]) if obj.get("image") is not None else None
        })
        return _obj
