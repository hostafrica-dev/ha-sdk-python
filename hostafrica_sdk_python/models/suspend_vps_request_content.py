...
class SuspendVpsRequestContent(BaseModel):
    """
    SuspendVpsRequestContent
    """ # noqa: E501
    service_id: StrictStr = Field(description="Service ID - must be sent as a string")
    suspend_reason: Annotated[str, Field(min_length=1, strict=True, max_length=500)] = Field(description="Reason for suspending the service")
    __properties: ClassVar[List[str]] = ["service_id", "suspend_reason"]
