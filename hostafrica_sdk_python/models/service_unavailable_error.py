...
class ServiceUnavailableError(BaseModel):
    ...
    retry_after: Optional[StrictInt] = Field(default=None, description="Number of seconds to wait before retrying")
    __properties: ClassVar[List[str]] = ["message", "data", "retry_after"]
